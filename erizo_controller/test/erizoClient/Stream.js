...
describe('Stream.init', function () {
    ...
    it('should get access to user media when requesting access to video and audio', async function() {
    ...
    it('should get access to user media when requesting access to video', async function() {
    ...
    it('should get access to user media when requesting access to audio', async function() {
    ...
    it('should get access to user media when requesting access to screen sharing', async function() {
