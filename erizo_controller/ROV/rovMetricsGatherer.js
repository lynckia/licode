...
class RovMetricsGatherer {
  constructor(rovClient, promClient, statsPrefix, logger) {
    ...
    this.prometheusMetrics = {
      ...
      taskDelay0To10ms: new promClient.Gauge({ name: this.getNameWithPrefix('task_delay_0_to_10_ms'), help: 'tasks lasted less than 10 ms' }),
      taskDelay10To50ms: new promClient.Gauge({ name: this.getNameWithPrefix('task_delay_10_to_50_ms'), help: 'tasks lasted between 10 and 50 ms' }),
      taskDelay50To100ms: new promClient.Gauge({ name: this.getNameWithPrefix('task_delay_50_to_100_ms'), help: 'tasks lasted between 50 and 100 ms' }),
      taskDelay100To1000ms: new promClient.Gauge({ name: this.getNameWithPrefix('task_delay_100_to_1000_ms'), help: 'tasks lasted between 100 ms and 1 s' }),
      taskDelayMoreThan1000ms: new promClient.Gauge({ name: this.getNameWithPrefix('task_delay_1000_ms'), help: 'tasks lasted more than 1 s' }),
      connectionPromiseDuration0To10ms: new promClient.Gauge({ name: this.getNameWithPrefix('connection_promise_duration_0_to_10_ms'), help: 'connection_promises lasted less than 10 ms' }),
      connectionPromiseDuration10To50ms: new promClient.Gauge({ name: this.getNameWithPrefix('connection_promise_duration_10_to_50_ms'), help: 'connection_promises lasted between 10 and 50 ms' }),
      connectionPromiseDuration50To100ms: new promClient.Gauge({ name: this.getNameWithPrefix('connection_promise_duration_50_to_100_ms'), help: 'connection_promises lasted between 50 and 100 ms' }),
      connectionPromiseDuration100To1000ms: new promClient.Gauge({ name: this.getNameWithPrefix('connection_promise_duration_100_to_1000_ms'), help: 'connection_promises lasted between 100 ms and 1 s' }),
      connectionPromiseDurationMoreThan1000ms: new promClient.Gauge({ name: this.getNameWithPrefix('connection_promise_duration_1000_ms'), help: 'connection_promises lasted more than 1 s' }),
      connectionPromiseDelay0To10ms: new promClient.Gauge({ name: this.getNameWithPrefix('connection_promise_delay_0_to_10_ms'), help: 'connection_promises lasted less than 10 ms' }),
      connectionPromiseDelay10To50ms: new promClient.Gauge({ name: this.getNameWithPrefix('connection_promise_delay_10_to_50_ms'), help: 'connection_promises lasted between 10 and 50 ms' }),
      connectionPromiseDelay50To100ms: new promClient.Gauge({ name: this.getNameWithPrefix('connection_promise_delay_50_to_100_ms'), help: 'connection_promises lasted between 50 and 100 ms' }),
      connectionPromiseDelay100To1000ms: new promClient.Gauge({ name: this.getNameWithPrefix('connection_promise_delay_100_to_1000_ms'), help: 'connection_promises lasted between 100 ms and 1 s' }),
      connectionPromiseDelayMoreThan1000ms: new promClient.Gauge({ name: this.getNameWithPrefix('connection_promise_delay_1000_ms'), help: 'connection_promises lasted more than 1 s' }),
      streamPromiseDuration0To10ms: new promClient.Gauge({ name: this.getNameWithPrefix('stream_promise_duration_0_to_10_ms'), help: 'stream_promises lasted less than 10 ms' }),
      streamPromiseDuration10To50ms: new promClient.Gauge({ name: this.getNameWithPrefix('stream_promise_duration_10_to_50_ms'), help: 'stream_promises lasted between 10 and 50 ms' }),
      streamPromiseDuration50To100ms: new promClient.Gauge({ name: this.getNameWithPrefix('stream_promise_duration_50_to_100_ms'), help: 'stream_promises lasted between 50 and 100 ms' }),
      streamPromiseDuration100To1000ms: new promClient.Gauge({ name: this.getNameWithPrefix('stream_promise_duration_100_to_1000_ms'), help: 'stream_promises lasted between 100 ms and 1 s' }),
      streamPromiseDurationMoreThan1000ms: new promClient.Gauge({ name: this.getNameWithPrefix('stream_promise_duration_1000_ms'), help: 'stream_promises lasted more than 1 s' }),
      streamPromiseDelay0To10ms: new promClient.Gauge({ name: this.getNameWithPrefix('stream_promise_delay_0_to_10_ms'), help: 'stream_promises lasted less than 10 ms' }),
      streamPromiseDelay10To50ms: new promClient.Gauge({ name: this.getNameWithPrefix('stream_promise_delay_10_to_50_ms'), help: 'stream_promises lasted between 10 and 50 ms' }),
      streamPromiseDelay50To100ms: new promClient.Gauge({ name: this.getNameWithPrefix('stream_promise_delay_50_to_100_ms'), help: 'stream_promises lasted between 50 and 100 ms' }),
      streamPromiseDelay100To1000ms: new promClient.Gauge({ name: this.getNameWithPrefix('stream_promise_delay_100_to_1000_ms'), help: 'stream_promises lasted between 100 ms and 1 s' }),
      streamPromiseDelayMoreThan1000ms: new promClient.Gauge({ name: this.getNameWithPrefix('stream_promise_delay_1000_ms'), help: 'stream_promises lasted more than 1 s' }),
