...
nvm use
npm install --loglevel error amqp socket.io@2.0.3 log4js@1.0.1 node-getopt uuid@3.1.0 sdp-transform@2.3.0 socket.io-client@2.0.3 webrtc-adapter@6.1.5 webpack-conditional-loader@1.0.12
