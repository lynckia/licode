...
RttBasedBackoff::RttBasedBackoff(const WebRtcKeyValueConfig* key_value_config) : disabled_("Disabled"),
...
SendSideBandwidthEstimation::SendSideBandwidthEstimation(const WebRtcKeyValueConfig* key_value_config)
