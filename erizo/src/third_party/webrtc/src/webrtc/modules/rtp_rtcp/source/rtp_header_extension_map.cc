...
#include "webrtc/modules/rtp_rtcp/source/rtp_dependency_descriptor_extension.h"
#include "webrtc/modules/rtp_rtcp/source/rtp_generic_frame_descriptor_extension.h"
