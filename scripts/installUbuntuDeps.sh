...
install_apt_deps(){
  ...
  sudo apt-get install -qq git make gcc-5 g++-5 libssl-dev cmake libglib2.0-dev pkg-config libboost-regex-dev libboost-thread-dev libboost-system-dev rabbitmq-server mongodb curl libboost-test-dev build-essential libtool autotools-dev automake libapr1.0-dev libaprutil1.0-dev zip -y
